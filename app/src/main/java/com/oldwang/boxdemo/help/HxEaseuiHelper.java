package com.oldwang.boxdemo.help;
...
import com.oldwang.boxdemo.bean.RobotUser;
import com.oldwang.boxdemo.db.Constant;
import com.oldwang.boxdemo.db.DemoModel;
import com.oldwang.boxdemo.db.InviteMessgeDao;
import com.oldwang.boxdemo.db.UserDao;
import com.oldwang.boxdemo.util.APPConfig;
import com.oldwang.boxdemo.util.SharedPreferencesUtils;
...
//            broadcastManager = LocalBroadcastManager.getInstance(appContext);
    ...
    private EaseUser getUserInfo(String username){
        ...
        if(username.equals(EMClient.getInstance().getCurrentUser())){
            ...
            if(!TextUtils.isEmpty(BaseActivity.getmUserHeandImage())) {
                user.setAvatar(BaseActivity.getmUserHeandImage());
            }else{
//                user.setAvatar(R.mipmap.mrtx);
            }
            user.setNickname(BaseActivity.getUserInfo(appContext).getMemberNickname());
            return user;
        }
        ...
        messageListener = new EMMessageListener() {
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                for (EMMessage message : messages) {
                    ...
                    //接收并处理扩展消息
                    String userName=message.getStringAttribute(APPConfig.USER_NAME,"");
                    String userId=message.getStringAttribute(Constant.USER_ID,"");
                    String userPic=message.getStringAttribute(APPConfig.USER_HEAD_IMG,"");
