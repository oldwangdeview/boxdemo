...
public class HomeSearchGoodsAdpater extends BaseRecycleAdapter<CommodityTypeData> {
    ...
    public HomeSearchGoodsAdpater(Context context, List<CommodityTypeData> datas) {
