...
import com.oldwang.boxdemo.adpater.CollectionVedioAdpater;
...
public class CollectionVideoFragment extends BaseFragment {
    ...
    private CollectionVedioAdpater madpater ;
     ...
     * 我的收藏
     */
    private void favoriteListByType(int favoriteType) {
        ...
        HttpUtil.getInstance().toSubscribe(observable, new ProgressSubscriber<DataInfo>(getContext()) {
            ...
            protected void _onNext(StatusCode<DataInfo> stringStatusCode) {
                if (stringStatusCode != null) {
                    ...
                    madpater = new CollectionVedioAdpater(mContext,mlistdata);
                    ...
                    madpater.setListOnclickLister(new ListOnclickLister() {
                        ...
                        public void onclick(View v, int position) {
                            VideoDetailActivity.startactivity(mContext,mlistdata.get(position).getFavoriteObjectId());
                        }
                    });
                }
            ...
            switch (event.updatatype){
                ...
                case 2:
                    ...
                    if (TextUtils.isEmpty(favoriteId)){
                        ToastUtils.makeText("请选择需要删除的收藏视频");
                        return;
                    }
