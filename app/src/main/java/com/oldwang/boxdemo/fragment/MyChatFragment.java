...
//        }
//        //设置要发送扩展消息用户昵称
//        message.setAttribute(Contans.INTENT_TYPE, (String) SharedPreferencesUtils.getParam(getActivity().getApplicationContext(), APPConfig.USER_NAME,""));
//        String headImgUrl=(String)SharedPreferencesUtils.getParam(getActivity().getApplicationContext(),APPConfig.USER_HEAD_IMG,"");
//        message.setAttribute(Contans.INTENT_DATA, headImgUrl);
//
//
//
//    }
