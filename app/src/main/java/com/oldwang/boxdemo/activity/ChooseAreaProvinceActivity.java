 ...
 * 选择收货地址区域列表-省
 */
public class ChooseAreaProvinceActivity extends BaseActivity {
    ...
    public static void startactivity(Context mContext){
        Intent mIntent = new Intent(mContext,ChooseAreaProvinceActivity.class);
                ...
                if (stringStatusCode != null) {
                    ...
                    madpater.setListClickLister(new ListOnclickLister() {
                        ...
                        public void onclick(View v, int position) {
                            ...
                            AreaTempData areaTempData = new AreaTempData();
                            areaTempData.setProvinceId(regionData1.getAreaId());
                            areaTempData.setName(regionData1.getFullname());

                            ChooseAreaCityActivity.startactivity(mContext, areaTempData);
                        }
                    });
                }
