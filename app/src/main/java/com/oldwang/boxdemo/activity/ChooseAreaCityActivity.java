...
public class ChooseAreaCityActivity extends BaseActivity {
    ...
    protected void initEvent() {
        super.initEvent();
        getData(2,areaTempData.getProvinceId());
    }
    ...
    public static void startactivity(Context mContext, AreaTempData areaTempData){
        Intent mIntent = new Intent(mContext,ChooseAreaCityActivity.class);
                ...
                if (stringStatusCode != null) {
                    ...
                    madpater.setListClickLister(new ListOnclickLister() {
                        ...
                        public void onclick(View v, int position) {
                            ...
                            areaTempData.setCityId(regionData1.getRegionId());
                            areaTempData.setName(areaTempData.getName()+regionData1.getRegionName());
                            ChooseAreaCountyActivity.startactivity(mContext, areaTempData);
                        }
                    });
                }
