 ...
 * 选择收货地址区域列表-省
 */
public class ChooseAreaTownshipActivity extends BaseActivity {
    ...
    protected void initEvent() {
        super.initEvent();
        getData(4,areaTempData.getCountyId());
    }
    ...
    public static void startactivity(Context mContext, AreaTempData areaTempData){
        Intent mIntent = new Intent(mContext,ChooseAreaTownshipActivity.class);
                ...
                if (stringStatusCode != null) {
                    ...
                    madpater.setListClickLister(new ListOnclickLister() {
                        ...
                        public void onclick(View v, int position) {
                            ...
                            areaTempData.setTownshipId(regionData1.getRegionId());
